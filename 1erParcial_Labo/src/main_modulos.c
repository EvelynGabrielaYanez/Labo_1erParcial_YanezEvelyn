	...
	if (hayElectrodomesticoCargado(listaElectrodomesticos,
		...
		do{
			do {
				...
				printf(" 1.INFORMAR LAS REPARACIONES POR CLIENTE.\n");
				printf(" 2.INFORMAR LAS REPARACIONES DE UN CLIENTE.\n");
				printf(" 3.INFORMAR LAS REPARACIONES POR ELECTRODOMESTICO.\n");
				printf(" 4.INFORMAR LAS REPARACIONES DE UN ELECTRODOMESTICO.\n");
				printf(" 5.INFORMAR LAS REPARACIONES DE IMPORTE MAYOR O IGUAL.\n");
				printf(" 6.INFORMAR LA CANTIDAD DE REPARACIONES POR CLIENTE.\n");
				printf(" 7.INFORMAR LA CANTIDAD DE REPARACIONES POR SERIE DE ELECTRODOMESTICO.\n");
				printf(" 8.INFORMAR EL ELECTRODOMESTICO CON MAYOR CANTIDAD DE REPARACIONES.\n");
				printf(" 9.INFORMAR EL CLIENTE CON MAYOR CANTIDAD DE REPARACIONES. \n");
				printf(" 10.INFORMAR LOS ELECTRODOMESTICOS POR MARCA. \n");
				printf(" 11.INFORMAR LOS ELECTRODOMESTICOS DE UNA MARCA. \n");
				printf(" 12.INFORMAR LA CANTIDAD DE ELECTRODOMESTICOS POR MARCA. \n");
				printf(" 13.INFORMAR LA MARCA CON MAYOR CANTIDAD DE ELECTRODOMESTICOS. \n");
				printf(" 14.INFORMAR EL PROMEDIO DE ELECTRODOMESTICOS POR MARCA. \n");
				printf(" 15.INFORMAR EL PROMEDIO DE REPARACIONES POR ELECTRODOMESTICO. \n");
				printf(" 16.INFORMAR EL PROMEDIO DE REPARACIONES POR CLIENTE.\n");
				printf(" 17.VOLVER\n");
				printf("---------------------------------------------------------------------------\n");
			...
			switch(vOpcionSubMenu){
			case 1:
				if(informeMostrarReparacionPorCliente(listaClientes, largoClientes,
						listaReparacion, largoReparacion, listaServicios, largoServicios) == 0)
				{
				...
				break;
			case 2:
				if(pedirClientePorId(&vIdIngresado, " Ingrese el id del cliente que desea el informe: ",
						" No ingreso un id valido. ", listaClientes, largoClientes, REINTENTOS)==0)
				{
					if(informeMostrarReparacionDeCliente(vIdIngresado,listaClientes,
							 largoClientes,listaReparacion,largoReparacion,
							listaServicios, largoServicios) == 0)
					{
						printf(" Informe finalizado. \n ");
						system("pause");
					}else{
						printf(" El cliente ingresado no tiene reparaciones para informar.\n ");
						system("pause");
					}
				}
				break;
			case 3:
				if(informeMostrarReparacionPorSerie(listaElectrodomesticos, largoElectrodomesticos,
						listaReparacion, largoReparacion, listaServicios, largoServicios, listaClientes, largoClientes) == 0)
				{
						printf(" Informe finalizado. \n ");
						system("pause");
				}
			...
			case 4:
				...
				break;
			case 5:
				if(utn_getNumeroConDecimalesMin(&importeIngresado, " Ingrese el limite de importe.",
						" Importe ingresado invalido.", 0 , REINTENTOS)==0)
				{
					if(informeReparacionesPorImporte(listaClientes, largoClientes, listaReparacion,
							largoReparacion, listaServicios, largoServicios, listaElectrodomesticos,
							largoElectrodomesticos, importeIngresado) == 0)
					{
						printf(" Informe finalizado. \n ");
						system("pause");
					}else{
						printf(" No hay reparaciones con un importe mayor o igual a %.2f. \n ", importeIngresado);
						system("pause");
					}
				}
				...
				break;
			case 6:
				if(informeCantidadRepPorCliente(listaClientes, largoClientes, listaReparacion,
						largoReparacion, listaServicios, largoServicios)==0)
				{
					printf(" Informe finalizado. \n ");
					system("pause");
				}
				...
				break;
			case 7:
				if(informeCantidadRepPorSerie(listaReparacion, largoReparacion, listaElectrodomesticos, largoElectrodomesticos) == 0)
				{
					printf(" Informe finalizado. \n ");
					system("pause");
				}
				...
				break;
			case 8:
				if(informarSerieConMasRep(listaReparacion, largoReparacion, listaElectrodomesticos, largoElectrodomesticos)==0)
				{
					printf(" Informe finalizado. \n ");
					system("pause");
				}
				break;
			case 9:
				if(informarClienteConMasRep(listaReparacion, largoReparacion, listaClientes, largoClientes)==0)
				{
					printf(" Informe finalizado. \n ");
					system("pause");
				}
				break;
			case 10:
				if(informarElectPorMarca(listaElectrodomesticos, largoElectrodomesticos, listaMarcas, largoMarcas)==0)
				{
					printf(" Informe finalizado. \n ");
					system("pause");
				}
			...
			case 11:
				...
				break;
			case 12:
				if(informarCantElectPorMarca(listaElectrodomesticos, largoElectrodomesticos, listaMarcas, largoMarcas)==0)
				{
					printf(" Informe finalizado. \n ");
					system("pause");
				}
				break;
			case 13:
				if(informarMarcaMayCantElect(listaElectrodomesticos, largoElectrodomesticos, listaMarcas, largoMarcas)==0)
				{
					printf(" Informe finalizado. \n ");
					system("pause");
				}
			break;
			case 14:
				if(informarPromedioElectrodPorMarca(listaElectrodomesticos, largoElectrodomesticos, listaMarcas, largoMarcas)==0)
				{
					printf(" Informe finalizado. \n ");
					system("pause");
				}
			break;
			case 15:
				if(informarPromedioRepaPorElect(listaReparacion, largoReparacion, listaElectrodomesticos, largoElectrodomesticos)==0)
				{
					printf(" Informe finalizado. \n ");
					system("pause");
				}
			break;
			case 16:
				if(informarPromedioRepaPorCliente(listaReparacion, largoReparacion, listaClientes, largoClientes)==0)
				{
					printf(" Informe finalizado. \n ");
					system("pause");
				}
			break;
			case 17://Pregunto si desea volver al menu
				do {
					vRespuestaVolver = unt_preguntaRespuestaBinaria(
							" Desea volver?(s/n) ", 's', 'n');
					system("cls");
